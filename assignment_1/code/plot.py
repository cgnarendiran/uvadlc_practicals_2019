...
plt.plot(train_loss)
plt.plot(test_loss)
plt.title('Loss curves for pytorch-MLP: best parameters')
plt.xlabel('Number of epochs x100')
plt.ylabel('Loss on the mini-batch')
plt.legend(['train loss', 'test loss'], loc='upper right')
plt.show()
...
plt.plot(train_acc)
plt.plot(test_acc)
plt.title('Accuracy curves for pytorch-MLP: best parameters')
plt.xlabel('Number of epochs x100')
plt.ylabel('Accuracy on the mini-batch')
plt.legend(['train accuracy', 'test accuracy'], loc='lower right')
plt.show()
...
################################################################
# train_loss = np.load('../cnn_results/cnn_loss_train.npy')
# test_loss = np.load('../cnn_results/cnn_loss_test.npy')

# train_acc = np.load('../cnn_results/cnn_accuracy_train.npy')
# test_acc = np.load('../cnn_results/cnn_accuracy_test.npy')

# plt.plot(train_loss)
# plt.plot(test_loss)
# plt.title('Loss curves for pytorch-CNN: default parameters')
...
# plt.plot(train_acc)
# plt.plot(test_acc)
# plt.title('Accuracy curves for pytorch-CNN: default parameters')
# plt.xlabel('Number of epochs x500')
# plt.ylabel('Accuracy on the mini-batch')
# plt.legend(['train accuracy', 'test accuracy'], loc='lower right')
# plt.show()